...
The total came to **USD $2.00**—about **CAD $2.46**. That's a low-risk price for trying a custom domain on a side project.
...
With credentials in place, Copilot returns the list of domains in your account—a quick way to confirm everything is wired up correctly before making any changes.
